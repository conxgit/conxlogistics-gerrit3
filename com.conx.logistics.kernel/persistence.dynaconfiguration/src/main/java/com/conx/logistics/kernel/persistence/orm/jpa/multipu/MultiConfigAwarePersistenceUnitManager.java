 ...
 */
package com.conx.logistics.kernel.persistence.orm.jpa.multipu;
...
public class MultiConfigAwarePersistenceUnitManager extends DefaultPersistenceUnitManager {
    ...
    private final Logger logger = LoggerFactory.getLogger(MultiConfigAwarePersistenceUnitManager.class);
