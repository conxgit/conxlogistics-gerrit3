...
public class BPMGuvnorUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BPMGuvnorUtil.class);
    private static Properties properties = new Properties();
    
    static {
        try {
            properties.load(BPMGuvnorUtil.class.getResourceAsStream("/jbpm.conxrepo.properties"));
        } catch (IOException e) {
    ...
    public String getProcessSourceContent(String packageName, String assetName) {
    ...
    public StringReader createChangeSet(List<String> packageNames) {
        try {
            StringTemplate changeSetTemplate = new StringTemplate(
                    readFile(BPMGuvnorUtil.class.getResourceAsStream("/ChangeSet.st")));
