...
@Table(name="sysuiformitemrepresentation")
public abstract class FormItemRepresentation extends MultitenantBaseEntity implements Mappable {
    ...
    public FormItemRepresentation(String typeId) {
        this.typeId = typeId;
        this.itemClassName = getClass().getName();
    }
