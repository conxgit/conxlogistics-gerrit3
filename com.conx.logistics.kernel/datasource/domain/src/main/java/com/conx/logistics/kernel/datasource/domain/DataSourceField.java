...
public class DataSourceField extends MultitenantBaseEntity {
     ...
     * field. <P> Must be unique across all fields within the DataSource and should be a valid JS identifier (with no dots,
     * spaces, or other non-alphanumeric characters except underscore).
     *
